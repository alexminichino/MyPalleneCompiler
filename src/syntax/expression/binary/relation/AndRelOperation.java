...
public class AndRelOperation extends BinaryOperation {
    /**
     ...
     */
    public AndRelOperation(Location leftPosition, Location rightPosition, Expr leftOperand, Expr rightOperand) {
