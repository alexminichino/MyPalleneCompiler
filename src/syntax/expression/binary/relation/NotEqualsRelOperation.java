...
public class NotEqualsRelOperation extends BinaryOperation {
    /**
     ...
     */
    public NotEqualsRelOperation(Location leftPosition, Location rightPosition, Expr leftOperand, Expr rightOperand) {
