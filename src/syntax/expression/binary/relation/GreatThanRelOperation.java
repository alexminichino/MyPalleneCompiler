...
public class GreatThanRelOperation extends BinaryOperation {
    /**
     ...
     */
    public GreatThanRelOperation(Location leftPosition, Location rightPosition, Expr leftOperand, Expr rightOperand) {
