...
public class LessThanRelOperation extends BinaryOperation {
    /**
     ...
     */
    public LessThanRelOperation(Location leftPosition, Location rightPosition, Expr leftOperand, Expr rightOperand) {
