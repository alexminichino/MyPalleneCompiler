...
public class TimesOperation extends BinaryOperation {
    /**
     ...
     */
    public TimesOperation(Location leftPosition, Location rightPosition, Expr leftOperand, Expr rightOperand) {
